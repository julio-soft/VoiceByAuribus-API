...
public interface IWebhookSubscriptionService
{
    ...
    Task<CreatedWebhookSubscriptionResponseDto> CreateSubscriptionAsync(
        CreateWebhookSubscriptionDto dto, Guid userId);
    ...
    Task<IEnumerable<WebhookSubscriptionResponseDto>> GetUserSubscriptionsAsync(Guid userId);
    ...
    Task<WebhookSubscriptionResponseDto?> GetSubscriptionByIdAsync(Guid id, Guid userId);
    ...
    Task<WebhookSubscriptionResponseDto?> UpdateSubscriptionAsync(
        Guid id, UpdateWebhookSubscriptionDto dto, Guid userId);
    ...
    Task<bool> DeleteSubscriptionAsync(Guid id, Guid userId);
    ...
    Task<RegenerateSecretResponseDto> RegenerateSecretAsync(Guid id, Guid userId);
    ...
    Task<WebhookTestResultDto> TestWebhookAsync(Guid id, Guid userId);
    ...
    Task<IEnumerable<WebhookDeliveryLogResponseDto>> GetDeliveryLogsAsync(
        Guid subscriptionId, Guid userId, int limit = 100);
}
